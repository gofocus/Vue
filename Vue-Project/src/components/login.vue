<template>
    <el-form :model="form" class="login-container" :rules="rules" ref="form">
      ...
      <el-form-item style="width: 100%;">
        <el-button type="primary" style="width: 100%;" @click.native.prevent="handleSubmit" :loading="logining">Submit</el-button>
      </el-form-item>
    </el-form>
</template>
        ...
        return {
          ...
          rules:{
            email:[
              ...
              // { type: 'email', message:'输入正确的邮箱地址', trigger: 'change'}
          ...
          handleSubmit(){
            this.$refs.form.validate((valid) => {
              if (valid) {
                ...
                // this.$ajax.post('/login', loginParams).then(data => {
